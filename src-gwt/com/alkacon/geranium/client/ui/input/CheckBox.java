...
implements HasClickHandlers, I_FormWidget, I_HasInit, HasHorizontalAlignment, HasValueChangeHandlers<Boolean> {
    ...
    private static final I_InputCss CSS = I_InputLayoutBundle.INSTANCE.inputCss();
    ...
    private final ToggleButton m_button;

    /** The error display for this widget. */
    private final ErrorWidget m_error;
    ...
    public FieldType getFieldType() {
        ...
        return I_FormWidget.FieldType.BOOLEAN;
    }
