...
public class LabelNonTextOverflowImpl extends Label {
     ...
     */
    public LabelNonTextOverflowImpl() {
     ...
     */
    public LabelNonTextOverflowImpl(Element element) {
     ...
     */
    public LabelNonTextOverflowImpl(String text) {
