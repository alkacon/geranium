...
import com.alkacon.geranium.client.util.DomUtil.Method;
 ...
 * 
 * Use to render the dialog content within an iFrame on top of a regular {@link com.alkacon.geranium.client.ui.Popup}.
...
public class FrameDialog {
    ...
    public FrameDialog() {
        ...
        if (m_isFrame) {
            ...
            m_main.addStyleName(I_LayoutBundle.INSTANCE.dialogCss().frameDialog());
            m_contentPanel = new SimplePanel();
            m_contentPanel.addStyleName(I_LayoutBundle.INSTANCE.dialogCss().popupMainContent());
            m_contentPanel.addStyleName(I_LayoutBundle.INSTANCE.dialogCss().contentPadding());
