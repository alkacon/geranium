...
public class ToolbarNotificationWidget extends A_NotificationWidget {
     ...
     */
    protected interface I_CmsNotificationWidgetUiBinder extends UiBinder<Widget, ToolbarNotificationWidget> {
     ...
     * Constructor.<p>
     */
    public ToolbarNotificationWidget() {

        initWidget(uiBinder.createAndBindUi(this));
        restore();
        Notification.get().setWidget(this);
    }
    ...
    private void restore() {
        ...
        getElement().setClassName(I_LayoutBundle.INSTANCE.toolbarCss().notification());
    }
}