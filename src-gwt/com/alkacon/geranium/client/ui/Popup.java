...
public class Popup extends PopupPanel implements I_AutoHider {
     ...
     * @param width the width to set
     */
    public Popup(String caption, int width) {
     ...
     */
    public Popup(String title, Widget content) {
    ...
    public void addButton(Widget button, int position) {
        ...
        m_buttonPanel.setStyleName(I_LayoutBundle.INSTANCE.dialogCss().popupButtonPanel());
    }
    ...
    public void addDialogClose(final Command cmd) {
        ...
        if (m_close == null) {
            ...
            m_close.addStyleName(I_LayoutBundle.INSTANCE.dialogCss().closePopup());
            m_close.setImageClass(I_LayoutBundle.INSTANCE.dialogCss().closePopupImage());
    ...
    public void catchNotifications() {
        ...
        final I_NotificationWidget widget = Notification.get().getWidget();
        // create our own notification overlay
        final A_NotificationWidget notificationWidget = createDialogNotificationWidget();
        add(notificationWidget);
        Notification.get().setWidget(notificationWidget);
        ...
        addCloseHandler(new CloseHandler<PopupPanel>() {
            ...
            public void onClose(CloseEvent<PopupPanel> event) {
                ...
                Notification.get().setWidget(widget);
    ...
    public boolean hasCaption() {
        ...
        return ClientStringUtil.isNotEmptyOrWhitespaceOnly(m_caption.getText());
    }
    ...
    public void removePadding() {
        ...
        m_main.removeClassName(I_LayoutBundle.INSTANCE.dialogCss().contentPadding());
    ...
    public void setCaption(String caption) {
        ...
        if (ClientStringUtil.isNotEmptyOrWhitespaceOnly(caption)) {
            getElement().removeClassName(I_LayoutBundle.INSTANCE.dialogCss().hideCaption());
     ...
     */
    protected A_NotificationWidget createDialogNotificationWidget() {

        return new DialogNotificationWidget();
    }
    ...
    protected void endDragging(MouseUpEvent event) {
        ...
        removeStyleName(I_LayoutBundle.INSTANCE.dialogCss().dragging());
    }
