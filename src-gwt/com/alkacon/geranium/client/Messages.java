...
public final class Messages {
    ...
    private static com.alkacon.geranium.client.util.Messages INSTANCE;
     ...
     */
    public static com.alkacon.geranium.client.util.Messages get() {

        if (INSTANCE == null) {
            INSTANCE = new com.alkacon.geranium.client.util.Messages(BUNDLE_NAME);
        }
        return INSTANCE;
    }
